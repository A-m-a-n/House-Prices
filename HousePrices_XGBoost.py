# -*- coding: utf-8 -*-
"""
Created on Tue Jun 19 01:57:58 2018
...
#MasVnrType filled with None and MasVnrArea with 0 where data is missing or NaN values are present
...
"""We used linear regression model to predict values for missing garage year built. WOW"""
...
"""Important to see how dictionary is been used here"""
...
xgb_regressor = XGBRegressor(seed=100)
...
param_test = {'learning_rate': common_num_range(0.2, 0.3, 0.02),
               ...
               'reg_lasso':common_num_range(0.40, 0.65, 0.01),
               'reg_ridge':common_num_range(0.40, 0.7, 0.01)}

"""param_test = {'reg_lasso':common_num_range(0.40, 0.65, 0.01),
              'reg_ridge':common_num_range(0.40, 0.7, 0.01)}"""
